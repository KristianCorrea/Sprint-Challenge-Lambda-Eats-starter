...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
    ...
    Similar to Route, useRouteMatch is mostly useful getting a match without rendering a Route.   

2. How would you explain form validation to someone who has never programmed before?

    Making sure that an input meets desired requirements.

3. In 1-2 sentences, define end to end testing.

    Its a technique used to test programs from beginning to end and verifies if the program is working correctly.
